$(document).ready(function () {
    ...
    function stringFeed(num) {
        ...
        $('.subCards:eq(' + num + ') .w3-container').after('<div class="starRating w3-row w3-light-grey"><div class="w3-col 12 m12 l9" style="padding:5px 0px;"><div class="star-ratings-sprite"><span style="width:' + rNum + '%" class="star-ratings-sprite-rating singleRate"></span></div></div><div class="w3-col s3 m3 l3 sm-hide" style="padding:7px 0px 5px 0px;"><i class="fa fa-shield w3-large rateNo" > ' + fig + '</i></div></div>');
...
$(window).scroll(function () {
    var fixSidebar = $('.w3-bar').innerHeight();
    //console.log(fixSidebar, "asdasdsa");
    var contentHeight = $('#game').innerHeight();
    var sidebarHeight = $('.w3-sidebar').height();
    var sidebarBottomPos = contentHeight - sidebarHeight;
    var trigger = $(window).scrollTop() - fixSidebar;

    if ($(window).scrollTop() >= fixSidebar) {
        $('.w3-sidebar').addClass('fixed');
    } else {
        $('.w3-sidebar').removeClass('fixed');
    }

    if (trigger >= sidebarBottomPos) {
        $('.w3-sidebar').addClass('bottom');
    } else {
        $('.w3-sidebar').removeClass('bottom');
    }
});
