    ...
    <div class="container" >
        <div class="content" style="background-color:#f4f7f8;color:black !important;">
            ...
            <div class="col-xs-3">
                ...
                <div class="col-xs-12">
                    <button class="option" id="add_question" ><i class="glyphicon glyphicon-plus"></i> Add Question</button>
                </div>
                <hr class="divider">
                <div class="col-xs-12 col-md-10 col-md-offset-2">
                    <div class="pull-right">
                        <button class="option"><i class="glyphicon glyphicon-remove"></i> Delete Quiz</button>
                        <button class="option" id="save-quiz"><i class="glyphicon glyphicon-floppy-save"></i> Save</button>
                    </div>
                </div>
            </form>
        </div>
