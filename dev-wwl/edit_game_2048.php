								...
								<div class="giRule">
									...
									<div class="girCheckbox">
										<div class="gircItem custom-tick">
											<input type="radio" <?php if($gamerow['Quiz_rules']==2)echo "checked";?> id="bestscore"  name="rule" value="2">
											<label>Best Highest Score</label>
										</div>
										<div class="gircItem custom-tick">
											<input type="radio" <?php if($gamerow['Quiz_rules']==3)echo "checked";?> id="time_bestscore"   name="rule" value="3">
       ...
       $.ajax({
        ...
        success: function(data){
         ...
         else
         {
             ...
             ?>
             var type=document.getElementById("game_selected").value;
             
                document.location="demo.php?id=<?php echo base64_encode($_REQUEST['id'])?>";
