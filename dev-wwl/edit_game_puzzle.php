					...
					<div class="row">
						<div class="col-sm-3">
							<div class="gameGraphic">
								...
								<div class="giTitle">
									<input type="text" id="game_name" value="<?php echo $gamerow['name']?>" name="game_name" placeholder="Game Title">
                            ...
                            else
                            {
								...
								<div class="gImagePreview">
                                    ...
                                    <?php if($gamerow['Image']!=""){
                                        ?>
                                        <img name="image12" id="image12" width="82px" src="<?php echo $gamerow['Image']?>"><br /><br />
                                        <?php
                                    }
                                    else
                                    {
							...
							<div class="gameInfoOther">
								<div class="giRule">
									...
									<div class="girCheckbox">
										<div class="gircItem custom-tick">
											<input type="radio" id="time_limit" <?php if($gamerow['time_limit']==1) echo "checked";?> name="limit" value="1"/>
											<label> Time Limit</label>
										</div>
										<div class="gircItem custom-tick">
											<input type="radio"  <?php if($gamerow['Steps']==1) echo "checked";?>  id="step_limit" name="limit" value="1">
								...
								<div class="giDifficulty">
									...
									<select id="level_game" name="level_game">
                                        ...
                                        for($j=4;$j<21;$j=$j+1)
                                        {?>
                                            <option <?php if($gamerow['Level']==$j) echo "selected";?> value='<?php echo $j?>'><?php echo $j?></option>
                                            <?php
                                        }
                                        ?>
                                        </optgroup>
