...
$page_title = "2048-Creation";
$page_description = "Create 2048 Game";
include("header.php"); 
?>
								...
								<div class="giRule">
									...
									<div class="girCheckbox">
										<div class="gircItem custom-tick">
											<input type="radio" id="bestscore"  name="rule" value="2">
											<label>Best Highest Score</label>
										</div>
										<div class="gircItem custom-tick">
											<input type="radio" id="time_bestscore" checked="true"  name="rule" value="3">
											<label>Timelimit + Won the game</label>
										</div>
									</div>
								</div>
        ...
        <div class="modal-content">
          ...
          <div class="row">
            ...
            <div class="game-type" style="padding-top: 15px;">
                  ...
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_address" id="charity_address" value="">
        </span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Contact Personnel:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_contact" id="charity_contact" value="">
        </span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Phone:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_phone" id="charity_phone" value="">
        </span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Tax ID:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_tax" id="charity_tax" value="">
        </span>
                </div>
                 <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Description:</label> <br />
                  <span id="g-type"><input type="text" style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" name="charity_description" id="charity_description" value="">
        </span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Non-Profit-501c3: <input type="checkbox" name="charity_non-profit" id="charity_non-profit" value="1"></label>
        </span>
                </div>
         ...
         <center>   <button class='play-btn' style="color: white;font-size: 12px;width: 50%;" type="button" onclick="addcharity()">Add Charity</button>
</center>
          </div>
...
$( "#gicdCharity" ).change(function() {
   ...
   if($('#bestscore').prop('checked')==true)
        {
            var gamerule=2;
        }
        else
