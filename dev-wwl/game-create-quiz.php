						...
						<div class="col-sm-3">
							<div class="gameGraphic">
                                ...
                                <!-- <div class="addQuizBtn">
                                  <a href="game-create-addquiz.php">Add Question</a>
                                </div> -->
                            </div>
			             </div>
                        <script>
							...
							<div class="gameInfoOther">
								<div class="giRule">
									...
									<div class="girCheckbox">
										<div class="gircItem custom-tick">
											<input type="radio" id="time_limitquiz" checked="true" name="rule" value="1">
											<label>First Come First Win(Score 100%)</label>
										</div>
										<div class="gircItem custom-tick">
											<input type="radio" id="highest_answer"  name="rule" value="2">
											<label>Most right answers</label>
										</div>
										<div class="gircItem custom-tick">
											<input type="radio" id="both" checked="true"  name="rule" value="3">
                                ...
                                <div class="giCredit">
                                  ...
                                  <div class="creation-submit">
                                    <button type="submit" onclick="done()">Add Questions</button>
                                  </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" id="closemodal" class="close" data-dismiss="modal">&times;</button>
            <center><h4 class="modal-title" style="color:#ff6666">Add Charity</h4></center>
          </div>
        <div class="modal-body" style="color:#ff6666">
          <div class="row">
            <div class="col-sm-12">
                <div class="game-title" >
                  <label style="font-size: 16px;">Charity Image:</label> 
                  <span id="g-title"><input type="file" name="charity_pic" id="charity_pic" value=""><img width="50px" height="50px" src="" id="image" style="display: none;">
                  <input type="hidden" name="picdata" id="picdata" value="">
                  </span>
                </div>
                <div class="game-title" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Name:</label> <br />
                  <span id="g-title"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" class="tt-hint" style="margin-bottom: 0px !important;" onkeyup="showResult(this.value,'resultmodal','modal')" name="charity_game_name" id="charity_game_name" required value=""><div id="resultmodal" style="display:none;width:100%" class="tt-dropdown-menu">kjhkl</div></span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Address:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_address" id="charity_address" value=""></span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Contact Personnel:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_contact" id="charity_contact" value=""></span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Phone:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_phone" id="charity_phone" value=""></span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Tax ID:</label> <br />
                  <span id="g-type"><input style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" type="text" name="charity_tax" id="charity_tax" value=""></span>
                </div>
                 <div class="game-type" style="padding-top: 15px;">
                  <label style="font-size: 16px;">Charity Description:</label> <br />
                  <span id="g-type"><input type="text" style="border: 1px solid rgba(236, 234, 233, 0.95);border-radius: 4px;padding: 5px;width: 90%;" name="charity_description" id="charity_description" value=""></span>
                </div>
                <div class="game-type" style="padding-top: 15px;">
                <label style="font-size: 16px;">Non-Profit-501c3: <input type="checkbox" name="charity_non-profit" id="charity_non-profit" value="1"></label></span>
                </div>
            </div>
        </div>
            
        <center><button class='play-btn' style="color: white;font-size: 12px;width: 50%;" type="button" onclick="addcharity()">Add Charity</button></center>
        </div>
...
-->
   ...
   if($('#time_limitquiz').prop('checked')==true)
    ...
    if (name  === ''|| charity==='' || credit_cost == '' || win_credit == '' || (day =='0' && hour=="0" && minute=='0' && winner_option!=2)|| (min_credit=="" && winner_option!=1)) {
       ...
       $.ajax({
        ...
        success: function(data){
         ...
         if(val[0]==1)
         {
            ...
            document.location="addquiz_new.php?id="+val[1];
